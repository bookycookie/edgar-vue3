<template>
	<div class="container-fluid">
		<Card>
			<template #title>Question form items</template>
			<template #content>
				<Accordion>
					<AccordionTab
            ...
            answer in multiple choice (ABC) questions or code questions?">
						...
						<br />
						Let's explain the entire grading algorithm with an example. To grade an MC question we must
						have:
						<ul>
						...
						<ol>
							<li>
								...
								<ul>
									<li>
										Question is awarded "unanswered points" defined in the GM, in our example - 0
									</li>
								</ul>
							</li>
							<li>
								...
								<ul>
									<li>
										CALCULATE the overall SUM_penalty_perc: line up the arrays and sum penalty
										percentages in the misalligned rows, eg:
										<table>
											<tr>
												<th>#</th>
												<th>correct</th>
								...
								This model (example) when all PPs are 100 requires everything to be correct, ie it is an
								all or nothing approach.
								<br />
								Try to calculate the score if PPs in the example above were [100, 10, 50, 50, 50] and
								try to explain such approach.
							</li>
						</ol>
					</AccordionTab>
					<AccordionTab
            ...
            test-cases?">
						...
						<br />
						The interpretation is to remove all trailing whitespace in every line and all whitespace after
						the last line.
						<br />
						Such whitespace is not visible on the screen and is hard to debug - the idea is to remove the
						"invisible" whitespace.
						<br />
						The image bellow shows an example of removed (yellow) whitespace. Obviously, whitespace is
						marked with dot.
						<br />
					...
					<AccordionTab header="3. What are MD enhancers?">
						MarkDown enhancers are custom tags written as HTML comments that enhance the MD functionality.
						These enhancers are currently implemented (the list will probably expand):
						<ul>
							<li>
								...
								assigned title (or "Show" if omitted) - the button toggles the content visibility, that
								is (un)collapse the content.
							</li>
						</ul>
					</AccordionTab>
				</Accordion>
