		...
		<Accordion multiple>
			<AccordionTab header="Flags (booleans)">
				<ul id="flags">
					...
					<li>
						<b>Async submit</b>
						when ON, and when the student submits the exam: the submission is saved, and student gets a
						reply and is redirected to the overview of exams (while grading continues in a background
						thread). If OFF (sync), grading is done as a part of the save-grade-reply-redirect chain.
						<br />
					...
					<li>
						<b>Forward only</b>
						- if ON, the students will not be able to go back and revisit questions, they can only move in
						one direction.
					</li>
					<li>
						<b>Anonymous stalk</b>
						- if ON, public URL for exam stalking will be enabled. This is used when staff that is NOT
						course staff is watching students as they write their exams and you want them to be able to see
						eg LOST FOCUSES and students' pictures and names. Public URL is constructed using the course and
						exam abbreviations, eg for course "Math1" and exam "E3" the URL would be:
						https://edgar.../stalk/math1/e3
						<br />
						It is made visible in All exam instances list.
					</li>
					<li>
						<b>Global</b>
						- if ON, the exam can be run from any academic year (you still **have to assign the valid
						from/to**). This is usefull when you want to avoid copying the exams from year to year, eg. a
						demo exam can be global and always available
					</li>
					<li>
						<b>Public</b>
						- if ON, the exam will be shown at the homescreen and students can simply start it without you
						communicating them the password. This is useful for eg homeworks and demo tests.
					</li>
				</ul>
			</AccordionTab>
			<AccordionTab header="Pace">
				<p>
					...
					<br />
					Pace is defined via array of seconds which states how many seconds must student wait to be able to
					run code.
					<br />
				...
				<ul id="pace">
					...
					<li>
						<b>Test pace</b>
						the pace array is applied with regards to the cummulative number of runs (of all questions)
					</li>
				</ul>
