...
const routes: RouteRecordRaw[] = [
	...
	{ path: '/ticket/mytickets_admin', name: RouteNames.TicketsAdmin, component: TicketsAdminView },
	{ path: '/test/def/list', name: RouteNames.ExamDefinitions, component: ExamDefinitionsView },
	{
	...
	{ path: '/test/instances/list', name: RouteNames.ExamInstances, component: ExamInstancesView },
	{ path: '/test/instances/dumpcsv', name: RouteNames.ExportStudentScores, component: ExportStudentScoresView },
	{ path: '/lecture/def/list', name: RouteNames.QuizDefinitions, component: QuizDefinitionsView },
	{ path: '/lecture/instances/list', name: RouteNames.QuizInstances, component: QuizInstancesView },
	{ path: '/lecture/startteacher', name: RouteNames.LectureQuiz, component: LectureQuizView },

	//! LEARN
	{ path: '/tutorial/def/new', name: RouteNames.NewTutorial, component: NewTutorialView },
	{ path: '/tutorial/def', name: RouteNames.TutorialDefinition, component: TutorialDefinitionView },
	{ path: '/tutorial', name: RouteNames.StartTutorial, component: StartTutorialView },
	{ path: '/exercise/def/new', name: RouteNames.NewExercise, component: NewExerciseView },
	{ path: '/exercise/def', name: RouteNames.ExerciseDefinition, component: ExerciseDefinitionView },
	{ path: '/exercise', name: RouteNames.StartExercise, component: StartExerciseView },
	{ path: '/feedback', name: RouteNames.Feedback, component: FeedbackView },

	//! QUESTIONS
	{ path: '/question/new', name: RouteNames.NewQuestion, component: NewQuestionView },
	{ path: '/question/edit/:id', name: RouteNames.EditQuestion, component: EditQuestionView },
	{ path: '/question', name: RouteNames.ListAllAndEdit, component: ListAllAndEditView },
	{ path: '/question/search', name: RouteNames.Search, component: SearchView },
	{ path: '/node/vis', name: RouteNames.NodeVis, component: NodeVisView },
	{ path: '/node/questions', name: RouteNames.NodeQuestions, component: NodeQuestionsView },
	{ path: '/node/vistree', name: RouteNames.NodeTreeVis, component: NodeTreeVisView },
	{ path: '/course/dataobject', name: RouteNames.CourseDataObject, component: CourseDataObjectView },

	//! PREFERENCES
	{ path: '/prefs/cmskin_admin', name: RouteNames.CodeMirrorSkin, component: CodeMirrorSkinView },

	//! PLAYGROUND
	{ path: '/playground/sandbox', name: RouteNames.CodeSandboxAdmin, component: CodeSandboxView },
	{ path: '/playground/snippet/store', name: RouteNames.SnippetStoreAdmin, component: SnippetStoreView },

	//! ANALYTICS
	{ path: '/analytics/tests/single', name: RouteNames.ExamAnalytics, component: ExamAnalyticsView },
	{
		path: '/analytics/score',
		name: RouteNames.ExamScoreDistributionAnalytics,
		component: ExamScoreDistributionAnalyticsView,
	},
	{ path: '/analytics/questions/bulk', name: RouteNames.QuestionsAnalytics, component: QuestionsAnalyticsView },
	{
	...
	{ path: '/analytics/scatterstudents', name: RouteNames.StudentsScatter, component: StudentsScatterView },
	{ path: '/analytics/highscore', name: RouteNames.HighScoreList, component: HighScoreListView },

	//! ADMINISTRATION
	{ path: '/upload/students', name: RouteNames.UploadStudents, component: UploadStudentsView },
	{ path: '/upload/faces', name: RouteNames.UploadImages, component: UploadImagesView },
	{ path: '/admin/student/list', name: RouteNames.StudentsList, component: StudentsListView },
	{ path: '/admin/teacher/list', name: RouteNames.TeachersList, component: TeachersListView },
	{ path: '/admin/user/list', name: RouteNames.UsersList, component: UsersListView },
	{ path: '/admin/logs/edgar', name: RouteNames.EdgarLogs, component: EdgarLogsView },
	{ path: '/admin/logs/nginx', name: RouteNames.NginxLogs, component: NginxLogsView },
	{ path: '/admin/onlineusers', name: RouteNames.WhoIsOnline, component: WhoIsOnlineView },

	//! HELP
	{ path: '/help/glossary', name: RouteNames.Glossary, component: GlossaryView },
	{ path: '/help/faq', name: RouteNames.FrequentlyAskedQuestions, component: FAQView },
	{ path: '/help/examform', name: RouteNames.ExamForm, component: ExamFormView },
	{ path: '/help/questionops', name: RouteNames.QuestionOperations, component: QuestionOperationsView },
	{ path: '/help/questionedit', name: RouteNames.QuestionForm, component: QuestionFormView },
	{ path: '/help/questiontemplate', name: RouteNames.TemplatedQuestions, component: TemplatedQuestionsView },
	{ path: '/help/questionscript', name: RouteNames.ScriptedQuestions, component: ScriptedQuestionsView },
	{ path: '/help/pa', name: RouteNames.PeerAssessment, component: PeerAssessmentView },
	{ path: '/help/ticketing', name: RouteNames.TicketingSystem, component: TicketingSystemView },
	{ path: '/help/manualgrading', name: RouteNames.ManualGrading, component: ManualGradingView },
	//? REDIRECTS
